...
rDownloadURL = {"main": "https://bitbucket.org/aouronga/xtream-ui/raw/master/main_xui_masoudgb.zip", "sub": "https://bitbucket.org/aouronga/xtream-ui/raw/master/sub_xui_masoudgb.zip"}
import os
...
def update(rType="MAIN"):
    if rType == "UPDATE":
        rlink = "https://bitbucket.org/aouronga/xtream-ui/raw/master/update.zip"
    else:
        rlink = "https://bitbucket.org/aouronga/xtream-ui/raw/master/release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://bitbucket.org/aouronga/xtream-ui/raw/master/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://bitbucket.org/aouronga/xtream-ui/raw/master/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
